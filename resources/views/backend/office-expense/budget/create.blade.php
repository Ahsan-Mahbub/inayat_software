...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">Add Employee Budget</h4>
...
<div class="row justify-content-center">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="{{route('budget.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="validationCustom01" placeholder="Budget Amount" name="amount" required="">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="validationCustom01">Purpose</label>
                            <input type="text" class="form-control" id="validationCustom01" placeholder="Budget Purpose" name="purpose">
                        </div>
                    </div>
