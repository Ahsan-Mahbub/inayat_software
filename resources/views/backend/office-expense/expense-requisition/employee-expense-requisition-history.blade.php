...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">{{$employee->name}} - Expense Requisition List</h4>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            @php
                                $sl = 1;
                            @endphp
                            @foreach($expense_requisitions as $expense)
                            <tr>
                    ...
                    {{ $expense_requisitions->appends(request()->except('page'))->links() }}
                </div>
