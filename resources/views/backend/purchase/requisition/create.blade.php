...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Add Quotation</h4>
    ...
    <div class="col-12 text-right mb-4">
        ...
        <button type="button" class="btn btn-info btn-sm waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-md">Add Product</button>
        @endisset
        @isset(auth()->user()->role->permission['permission']['supplier']['create'])
        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-md-supplier">Add Supplier</button>
        @endisset
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-3 pb-3">
                                ...
                                <div class="">
                                    <select class="custom-select select2" name="supplier_id" id="supplier_id" onchange="getSupplierInfo()">
                        ...
                        <div class="add_item" id="add_item">
                            <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
                                <div class="row mb-1">
                                    ...
                                    <div class="col-4">
                                        <input type="text" class="form-control search_product search_product-202112" id="first_product_row" name="product_name[]" placeholder="Search by Product Code.." value="" >
                                    </div>
                                    ...
                                    <div class="col-2 d-none">
                                        <input type="text" id="textToNumber" class="form-control unitPrice-202112" name="unit_price[]" placeholder="Price.." required>
                                    </div>                        
                                    <div class="col-3">
                    ...
                    <div class="card">
                        <div class="card-header">
                          <ul class="nav nav-tabs justify-content-center" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link active product_tab" id="product_tab" data-toggle="tab" href="#product" role="tab">
                                 Product
                              </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="card-body">
                          ...
                          <div class="tab-content">
                            <div class="tab-pane active" id="product" role="tabpanel">
                              <form class="needs-validation" novalidate="" action="{{route('product.store')}}" method="post" id="add_product_form">
                                  @csrf
                                  <div class="row">
                                      <div class="col-md-6 mb-3">
                                          <label for="validationCustom01">Product Code</label>
                                          <input type="text" class="form-control" id="validationCustom01" placeholder="Product Code" name="sku">
                                      </div>
                                      <div class="col-md-6 mb-3">
                                          <label>Product Category</label>
                                          <div>
                                            <select class="custom-select select2" name="category_id" id="category_id" onchange="getSubCategory()">
                                                <option value="">Select One</option>
                            ...
                            <div class="tab-pane" id="category" role="tabpanel">
                                <form class="needs-validation" novalidate="" action="{{route('category.store')}}" id="add_category_form" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label for="validationCustom01">Category Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="validationCustom01" name="category_name" placeholder="Category Name">
    ...
    {{-- Add Modal --}}
    <div class="modal fade bs-example-modal-md-supplier" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        ...
        $(document).ready(function() {
            ...
            $("body").on("keyup", ".search_product-202112", function(e) {
                ...
                $.ajax({
                    ...
                    type: "GET",
                    url: "requisition-search-product",
                    data: {
                        search: searchData,
        ...
        $(document).on('change', '#unit_id', function(){
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    // }else{
                    //     $(`.unitPrice-${random_number}`).val(result.product.purchase_price ? result.product.purchase_price : 0);
                    // }
                    $(`.unitPrice-${random_number}`).val(result.product.purchase_price ? result.product.purchase_price : 0);
                }
            })
                ...
                success: function(resp){
                    ...
                    if (resp.status == 'error') {
                        $.each(resp.errors, function(i, error){
                            ...
                            setTimeout(function(){
                                $('#product-add-'+i).css({'display': 'none'});
                            },[3000]);
                        });
                    }
                },
                ...
                success: function(resp){
                    ...
                    if (resp.status == 'error') {
                        $.each(resp.errors, function(i, error){
                            ...
                            setTimeout(function(){
                                $('#category-add-'+i).css({'display': 'none'});
                            },[3000]);
                        });
                    }
                },
