...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Add Sale Quotation</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="/">Dashboard</a></li>
                        <li class="breadcrumb-item">Sale Quotation</li>
                        <li class="breadcrumb-item active">Add Sale Quotation</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <form method="post" action="{{route('sale.requisition.store')}}">
        @csrf
        ...
        $(document).ready(function() {
            ...
            $("body").on("keyup", ".search_product-202112", function(e) {
                ...
                $.ajax({
                    ...
                    type: "GET",
                    url: "sale-requisition-search-product",
                    data: {
                        search: searchData,
